...
function toolToOllamaFormat(tool) {
  const parameters = tool.parameters instanceof zod.z.ZodType ? zodToOllamaFormat(tool.parameters) : tool.parameters;
  return {
    type: "function",
    function: {
      name: tool.name,
...
var ToolRegistry = class _ToolRegistry {
  ...
  async executeOne(toolCall, ctx) {
    ...
    if (tool.parameters instanceof zod.z.ZodType) {
...
exports.OllamaAgentMaxIterationsError = OllamaAgentMaxIterationsError;
...
exports.OllamaMcpError = OllamaMcpError;
...
exports.OllamaSkillInvalidError = OllamaSkillInvalidError;
exports.OllamaSkillNotFoundError = OllamaSkillNotFoundError;
exports.OllamaStream = OllamaStream;
exports.OllamaTimeoutError = OllamaTimeoutError;
exports.OllamaToolExecutionError = OllamaToolExecutionError;
exports.OllamaToolValidationError = OllamaToolValidationError;
exports.OllamaUnknownToolError = OllamaUnknownToolError;
...
exports.toolToOllamaFormat = toolToOllamaFormat;
